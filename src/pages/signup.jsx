...
const Signup = () => {
    ...
    const handleSignup = (e) => {
        e.preventDefault();
        console.log("Signup clicked with:", fullName, email, password);
    };
        ...
        <div className="flex h-screen w-full overflow-hidden font-['Fredoka']">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center items-start -ml-16 px-4 sm:px-10 md:px-20 lg:px-28 pt-4 pb-36 relative bg-white">
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="w-full bg-[#FCD0DA] border border-black py-3 text-lg font-black tracking-widest uppercase rounded-xl shadow-md hover:scale-105 transition duration-300"
                        style={{ fontFamily: "'Luckiest Guy', cursive" }}
                    >
                        Sign Up
                    </button>
